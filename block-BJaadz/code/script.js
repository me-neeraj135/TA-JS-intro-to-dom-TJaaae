...
// allHrsArray.forEach(hr => (hr.style.backgroundColor = `antiquewhite`));
...
let hrWithImg = document.querySelectorAll(`.image`);
hrWithImg.forEach(e => (e.style.border = `2px solid purple`));
// Hide the box number 17 (last box).
document.querySelector(`.seventeen`).style.display = `none`;
// Change the border of all the hr element from solid to dashed type
allHrsArray.forEach(a => (a.style.border = `dashed`));
...
var boxSixteen = document.querySelector(`.sixteen`);

let boxParent16 = boxSixteen.parentNode;
let boxChilde16 = boxSixteen.childNodes;
let box16preSib = boxSixteen.previousSibling;
let box16NxtSib = boxSixteen.nextSibling;
let box16FirstChilde = boxSixteen.firstChild;
let box16lastChilde = boxSixteen.lastChild;
let box16previousElementSibling = boxSixteen.previousElementSibling;
let box16nextElementSibling = boxSixteen.nextElementSibling;
let box16firstElementChild = boxSixteen.firstElementChild;
let box16lastElementChild = boxSixteen.lastElementChild;
...
imgElm.src = `https://images.unsplash.com/photo-1644477478212-dabc81905eac?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80`;
