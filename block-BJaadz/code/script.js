...
allHrsArray.forEach(hr => (hr.style.color = `tomato`));
allHrsArray.forEach(hr => (hr.style.border = `1px`));
...
var boxSixteen = document.getElementsByClassName(`box sixteen`);

// Select box 2 and append a new paragraph element with content "Append inserts as last child" just after hr element.
let two = document.getElementsByClassName(`box two awesome-box`);
